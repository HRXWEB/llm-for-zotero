...
export function buildSemanticPrompt(
  ...
  return [
    ...
    '{"schemaVersion":1,"taskKind":"read|write|mixed","queryLanguage":"en","requestedScopes":["none|single-paper|paper-set|library-corpus|note|visual-input"],"selections":[{"skillId":"existing skill ID","requestedScope":"single-paper","evidenceText":"exact user text","occurrence":0}],"retrievalIntent":"enumerate|verify|summarize|none","deliverableIntent":"chat|document|unspecified","paperTargetIntent":"active|added|all_visible|unspecified","externalSearchIntent":"none|web|literature|both","wantedSections":[],"writeDisposition":"none|required|uncertain","actionIntents":[],"decisions":{"constraints":[],"noteDestination":"none|zotero|file|both","conversationOnly":false,"responseIntent":"receipt|answer","generationMode":"transform|reason","reading":{"source":"provided_context|metadata|document_text|rendered_pages","coverage":"overview|targeted|exhaustive"},"literature":"none|discover|import|select_then_import","bulk":false,"continuation":"new|resume|revise","questions":[]}}',
